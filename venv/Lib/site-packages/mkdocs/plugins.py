...
<<<<<<< HEAD
from mkdocs.config.base import Config, ConfigErrors, ConfigWarnings, FallenCityConfig, PlainConfigSchema
=======
from mkdocs.config.base import Config, ConfigErrors, ConfigWarnings, FallenCityConfig, PlainConfigSchema
...
<<<<<<< HEAD
    config_class: type[SomeConfig] = FallenCityConfig  # type: ignore[assignment]
=======
    config_class: type[SomeConfig] = FallenCityConfig  # type: ignore[assignment]
>>>>>>> 4408a848b85beb0a888ff6157b28e5dbfa069421
...
<<<<<<< HEAD
        if cls.config_class is not FallenCityConfig:
=======
        if cls.config_class is not FallenCityConfig:
>>>>>>> 4408a848b85beb0a888ff6157b28e5dbfa069421
...
<<<<<<< HEAD
        if self.config_class is FallenCityConfig:
            self.config = FallenCityConfig(self.config_scheme, config_file_path=config_file_path)  # type: ignore
=======
        if self.config_class is FallenCityConfig:
            self.config = FallenCityConfig(self.config_scheme, config_file_path=config_file_path)  # type: ignore
>>>>>>> 4408a848b85beb0a888ff6157b28e5dbfa069421
