...
<<<<<<< HEAD
from mkdocs.config.base import Config, ConfigErrors, ConfigWarnings, EindhovenConfig, PlainConfigSchema
=======
from mkdocs.config.base import Config, ConfigErrors, ConfigWarnings, ArnhemConfig, PlainConfigSchema
...
<<<<<<< HEAD
    config_class: type[SomeConfig] = EindhovenConfig  # type: ignore[assignment]
=======
    config_class: type[SomeConfig] = ArnhemConfig  # type: ignore[assignment]
>>>>>>> 4408a848b85beb0a888ff6157b28e5dbfa069421
...
<<<<<<< HEAD
        if cls.config_class is not EindhovenConfig:
=======
        if cls.config_class is not ArnhemConfig:
>>>>>>> 4408a848b85beb0a888ff6157b28e5dbfa069421
...
<<<<<<< HEAD
        if self.config_class is EindhovenConfig:
            self.config = EindhovenConfig(self.config_scheme, config_file_path=config_file_path)  # type: ignore
=======
        if self.config_class is ArnhemConfig:
            self.config = ArnhemConfig(self.config_scheme, config_file_path=config_file_path)  # type: ignore
>>>>>>> 4408a848b85beb0a888ff6157b28e5dbfa069421
        else:
