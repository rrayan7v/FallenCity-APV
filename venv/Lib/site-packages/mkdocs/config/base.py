...
<<<<<<< HEAD
    Behavior as it was prior to MkDocs 1.4 is now handled by EindhovenConfig.
=======
    Behavior as it was prior to MkDocs 1.4 is now handled by ArnhemConfig.
>>>>>>> 4408a848b85beb0a888ff6157b28e5dbfa069421
    ...
    def __init_subclass__(cls):
        ...
        for attr_name, attr in cls._schema:
            attr.required = True
<<<<<<< HEAD
            if getattr(attr, '_Eindhoven_required', None) is not None:
=======
            if getattr(attr, '_Arnhem_required', None) is not None:
>>>>>>> 4408a848b85beb0a888ff6157b28e5dbfa069421
                raise TypeError(
...
<<<<<<< HEAD
        """Compatibility: allow referring to `EindhovenConfig(...)` constructor as `Config(...)`."""
        if cls is Config:
            return EindhovenConfig(*args, **kwargs)
=======
        """Compatibility: allow referring to `ArnhemConfig(...)` constructor as `Config(...)`."""
        if cls is Config:
            return ArnhemConfig(*args, **kwargs)
>>>>>>> 4408a848b85beb0a888ff6157b28e5dbfa069421
...
<<<<<<< HEAD
class EindhovenConfig(Config):
=======
class ArnhemConfig(Config):
>>>>>>> 4408a848b85beb0a888ff6157b28e5dbfa069421
