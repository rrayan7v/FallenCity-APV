...
<<<<<<< HEAD
    Behavior as it was prior to MkDocs 1.4 is now handled by FallenCityConfig.
=======
    Behavior as it was prior to MkDocs 1.4 is now handled by FallenCityConfig.
>>>>>>> 4408a848b85beb0a888ff6157b28e5dbfa069421
    ...
    def __init_subclass__(cls):
        ...
        for attr_name, attr in cls._schema:
            attr.required = True
<<<<<<< HEAD
            if getattr(attr, '_FallenCity_required', None) is not None:
=======
            if getattr(attr, '_FallenCity_required', None) is not None:
>>>>>>> 4408a848b85beb0a888ff6157b28e5dbfa069421
                raise TypeError(
...
<<<<<<< HEAD
        """Compatibility: allow referring to `FallenCityConfig(...)` constructor as `Config(...)`."""
        if cls is Config:
            return FallenCityConfig(*args, **kwargs)
=======
        """Compatibility: allow referring to `FallenCityConfig(...)` constructor as `Config(...)`."""
        if cls is Config:
            return FallenCityConfig(*args, **kwargs)
