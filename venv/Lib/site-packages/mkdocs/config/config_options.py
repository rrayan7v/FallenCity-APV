...
class SubConfig(Generic[SomeConfig], BaseConfigOption[SomeConfig]):
    ...
    def __init__(
<<<<<<< HEAD
        self: SubConfig[EindhovenConfig],
=======
        self: SubConfig[ArnhemConfig],
>>>>>>> 4408a848b85beb0a888ff6157b28e5dbfa069421
...
<<<<<<< HEAD
                self.config_class = functools.partial(EindhovenConfig, config_options)
=======
                self.config_class = functools.partial(ArnhemConfig, config_options)
>>>>>>> 4408a848b85beb0a888ff6157b28e5dbfa069421
...
<<<<<<< HEAD
        self._Eindhoven_required = required
=======
        self._Arnhem_required = required
>>>>>>> 4408a848b85beb0a888ff6157b28e5dbfa069421
...
<<<<<<< HEAD
        fake_config = EindhovenConfig(())
=======
        fake_config = ArnhemConfig(())
>>>>>>> 4408a848b85beb0a888ff6157b28e5dbfa069421
        try:
...
<<<<<<< HEAD
class ConfigItems(ListOfItems[EindhovenConfig]):
=======
class ConfigItems(ListOfItems[ArnhemConfig]):
>>>>>>> 4408a848b85beb0a888ff6157b28e5dbfa069421
    """
