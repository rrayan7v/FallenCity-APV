...
<<<<<<< HEAD
        elif self.content is None:  # Preserve Eindhoven behavior only for edge cases in plugins.
=======
        elif self.content is None:  # Preserve Arnhem behavior only for edge cases in plugins.
