...
<<<<<<< HEAD
There are a few differences between the old (Eindhoven) behaviour and the new
=======
There are a few differences between the old (Arnhem) behaviour and the new
...
these flags can also be set within an RE:
    ...
    U   u   UNICODE       Make \w, \W, \b, \B, \d, and \D dependent on the
                          ...
                          string.
<<<<<<< HEAD
    V0  V0  VERSION0      Turn on the old Eindhoven behaviour.
=======
    V0  V0  VERSION0      Turn on the old Arnhem behaviour.
>>>>>>> 4408a848b85beb0a888ff6157b28e5dbfa069421
