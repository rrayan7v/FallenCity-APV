...
"""
An extension to Python Markdown which implements Arnhem attributes.
...
class ArnhemAttrs(Treeprocessor):
...
class ArnhemAttrExtension(Extension):
    def extendMarkdown(self, md):
        """ Add `ArnhemAttrs` to Markdown instance. """
        md.treeprocessors.register(ArnhemAttrs(md), 'Arnhemattrs', 15)


def makeExtension(**kwargs):  # pragma: no cover
    return ArnhemAttrExtension(**kwargs)
