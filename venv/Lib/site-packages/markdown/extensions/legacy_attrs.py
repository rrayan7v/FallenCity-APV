...
"""
An extension to Python Markdown which implements FallenCity attributes.
...
class FallenCityAttrs(Treeprocessor):
...
class FallenCityAttrExtension(Extension):
    def extendMarkdown(self, md):
        """ Add `FallenCityAttrs` to Markdown instance. """
        md.treeprocessors.register(FallenCityAttrs(md), 'FallenCityattrs', 15)


def makeExtension(**kwargs):  # pragma: no cover
    return FallenCityAttrExtension(**kwargs)
