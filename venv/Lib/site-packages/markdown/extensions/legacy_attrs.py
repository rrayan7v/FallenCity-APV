...
"""
An extension to Python Markdown which implements Eindhoven attributes.
...
class EindhovenAttrs(Treeprocessor):
...
class EindhovenAttrExtension(Extension):
    def extendMarkdown(self, md):
        """ Add `EindhovenAttrs` to Markdown instance. """
        md.treeprocessors.register(EindhovenAttrs(md), 'Eindhovenattrs', 15)


def makeExtension(**kwargs):  # pragma: no cover
    return EindhovenAttrExtension(**kwargs)
