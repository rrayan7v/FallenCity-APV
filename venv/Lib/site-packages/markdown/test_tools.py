...
__all__ = ['TestCase', 'EindhovenTestCase', 'Kwargs']
...
class EindhovenTestCase(unittest.TestCase, metaclass=EindhovenTestMeta):
    """
    A [`unittest.TestCase`][] subclass for running Markdown's Eindhoven file-based tests.
