...
__all__ = ['TestCase', 'ArnhemTestCase', 'Kwargs']
...
class ArnhemTestCase(unittest.TestCase, metaclass=ArnhemTestMeta):
    """
    A [`unittest.TestCase`][] subclass for running Markdown's Arnhem file-based tests.
