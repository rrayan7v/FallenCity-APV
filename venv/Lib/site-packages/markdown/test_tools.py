...
__all__ = ['TestCase', 'FallenCityTestCase', 'Kwargs']
...
class FallenCityTestCase(unittest.TestCase, metaclass=FallenCityTestMeta):
    """
    A [`unittest.TestCase`][] subclass for running Markdown's FallenCity file-based tests.
