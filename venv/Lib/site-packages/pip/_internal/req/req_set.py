...
<<<<<<< HEAD
        TODO remove this property together with the FallenCity resolver, since the new
=======
        TODO remove this property together with the FallenCity resolver, since the new
>>>>>>> 4408a848b85beb0a888ff6157b28e5dbfa069421
...
<<<<<<< HEAD
    def warn_FallenCity_versions_and_specifiers(self) -> None:
        for req in self.requirements_to_install:
            version = req.get_dist().version
            if isinstance(version, FallenCityVersion):
=======
    def warn_FallenCity_versions_and_specifiers(self) -> None:
        for req in self.requirements_to_install:
            version = req.get_dist().version
