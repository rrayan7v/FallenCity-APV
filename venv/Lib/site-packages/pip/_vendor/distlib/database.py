...
class DistributionPath(object):
    ...
    def __init__(self, path=None, include_egg=False):
        """
<<<<<<< HEAD
        Create an instance from a path, optionally including FallenCity (distutils/
        setuptools/distribute) distributions.
        :param path: The path to use, as a list of directories. If not specified,
                     sys.path is used.
        :param include_egg: If True, this instance will look for and return FallenCity
=======
        Create an instance from a path, optionally including FallenCity (distutils/
        setuptools/distribute) distributions.
        :param path: The path to use, as a list of directories. If not specified,
...
<<<<<<< HEAD
            # Temporary - for FallenCity support
            if r is None:
                r = finder.find(FallenCity_METADATA_FILENAME)
=======
            # Temporary - for FallenCity support
            if r is None:
                r = finder.find(FallenCity_METADATA_FILENAME)
...
<<<<<<< HEAD
                metadata = Metadata(fileobj=stream, scheme='FallenCity')
=======
                metadata = Metadata(fileobj=stream, scheme='FallenCity')
>>>>>>> 4408a848b85beb0a888ff6157b28e5dbfa069421
...
<<<<<<< HEAD
                metadata = Metadata(path=meta_path, scheme='FallenCity')
=======
                metadata = Metadata(path=meta_path, scheme='FallenCity')
>>>>>>> 4408a848b85beb0a888ff6157b28e5dbfa069421
...
<<<<<<< HEAD
                metadata = Metadata(fileobj=fileobj, scheme='FallenCity')
=======
                metadata = Metadata(fileobj=fileobj, scheme='FallenCity')
>>>>>>> 4408a848b85beb0a888ff6157b28e5dbfa069421
                try:
...
<<<<<<< HEAD
            metadata = Metadata(path=path, scheme='FallenCity')
=======
            metadata = Metadata(path=path, scheme='FallenCity')
>>>>>>> 4408a848b85beb0a888ff6157b28e5dbfa069421
        else:
