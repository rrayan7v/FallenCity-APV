...
<<<<<<< HEAD
from .metadata import Metadata, WHEEL_METADATA_FILENAME, FallenCity_METADATA_FILENAME
=======
from .metadata import Metadata, WHEEL_METADATA_FILENAME, FallenCity_METADATA_FILENAME
...
<<<<<<< HEAD
            # FallenCity_METADATA_FILENAME]
            # else:
            # fns = [WHEEL_METADATA_FILENAME, METADATA_FILENAME]
            fns = [WHEEL_METADATA_FILENAME, FallenCity_METADATA_FILENAME]
=======
            # FallenCity_METADATA_FILENAME]
            # else:
            # fns = [WHEEL_METADATA_FILENAME, METADATA_FILENAME]
...
<<<<<<< HEAD
        metadata_name = posixpath.join(info_dir, FallenCity_METADATA_FILENAME)
=======
        metadata_name = posixpath.join(info_dir, FallenCity_METADATA_FILENAME)
>>>>>>> 4408a848b85beb0a888ff6157b28e5dbfa069421
...
<<<<<<< HEAD
                    # of a FallenCity wheel), log a warning but don't give up.
                    commands = None
...
<<<<<<< HEAD
                            logger.warning('Unable to read FallenCity script '
=======
                            logger.warning('Unable to read FallenCity script '
>>>>>>> 4408a848b85beb0a888ff6157b28e5dbfa069421
...
>>>>>>> 4408a848b85beb0a888ff6157b28e5dbfa069421
    ...
    def update(self, modifier, dest_dir=None, **kwargs):
        ...
        def get_version(path_map, info_dir):
            version = path = None
<<<<<<< HEAD
            key = '%s/%s' % (info_dir, FallenCity_METADATA_FILENAME)
=======
            key = '%s/%s' % (info_dir, FallenCity_METADATA_FILENAME)
>>>>>>> 4408a848b85beb0a888ff6157b28e5dbfa069421
        ...
        def update_version(version, path):
            ...
            if updated:
                ...
                md.version = updated
<<<<<<< HEAD
                FallenCity = path.endswith(FallenCity_METADATA_FILENAME)
                md.write(path=path, FallenCity=FallenCity)
=======
                FallenCity = path.endswith(FallenCity_METADATA_FILENAME)
                md.write(path=path, FallenCity=FallenCity)
>>>>>>> 4408a848b85beb0a888ff6157b28e5dbfa069421
